...
def attack(char_name: str, char_class: str) -> str:
    """Выводит случайное значение урона, который нанесён противнику."""
...
def defence(char_name: str, char_class: str) -> str:
    """Выводит случайное значение заблокированного урона."""
    if char_class == 'warrior':
    ...
    return (f'{char_name} не блокировал {10 + randint(2, 5)} урона')


def special(char_name: str, char_class: str) -> str:
    """Выводит значение применённого специального умения."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Показывает характеристику персонажа и начинает тренировку."""
    if char_class == 'warrior':
